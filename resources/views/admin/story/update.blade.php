                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div id="select-multi-category" data-story-id="{{!empty($oneItem->id) ? $oneItem->id : 0}}"></div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Tag</label>
                                                        <div id="select-multi-tag" data-story-id="{{!empty($oneItem->id) ? $oneItem->id : 0}}"></div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Source origin</label>
                                                        <input type="text" class="form-control" name="source_origin" value="{{$oneItem->source_origin ?? ''}}">
                                                    </div>
                                                    @if ($level_id == 1)
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="author" value="{{$oneItem->author ?? ''}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
