                    ...
                    @if (!empty($view_hight))
                        @foreach ($view_hight as $k => $v)
                            <div class="ms-2 mt-2 pb-2 border-bottom d-flex d-nowrap">
                                ...
                                <div class="col-8">
                                    <a href="{{ getUrlStory($v) }}" title="{{ $v->title }}"
                                        class="d-block m-0 p-0 ps-2 max-line-2">{{ $v->title }}</a>
                                    <div class="col-9 fs-12 ps-2 text-grey1">{{ $v->author }}</div>
                                    <div class="row mt-1 ms-0">

                                        <div class="col-9 fs-12 ps-2">{{ $v->is_update }}</div>
                                        <div class="col-3 text-end fs-12 fst-italic d-flex"><i class="icon-eye pt-1"></i>
                                            <p class="ms-1"> {{ $v->view_count }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-2 col-6">
                            <div class="card mt-2 h-314">
                                {!! genImage(
                                    ...
                                    200,
                                    200,
                                    'card-img-top mt-2 rounded-circle h-178 w-100 p-0 img-fluid px-2',
                                    $ft->title,
                                ) !!}
        ...
        <div class="section-4 mt-5 row">
            <div class="col-lg-9">
                            ...
                            <div class="col-lg-3 col-6 mt-2">
                                <a href="{{ getUrlStory($n) }}" class="card p-0 ml-2">
                                    ...
                                    <div class="card-body dark-linear position-absolute fixed-bottom">
                                        ...
                                        <p class="p-0 m-0 text-grey1 d-flex align-items-center"><i
                                                class="icon-eye pt-1 pe-1"></i> Lượt xem: {{ $vh->view_count }}</p>
                                    </div>
                                </a>
                            </div>
                        @endforeach
                ...
                <div class="text-center">
                    <button class="btn btn-secondary bg-white text-dark mt-2">Xem thêm <span
                            class="icon-arrow_forward_ios"></span></button>
                </div>
                                ...
                                <li class="item d-block">
                                    <a href="{{ getUrlStory($fl) }}" class="card p-0 ml-2">
                                        ...
                                        <div class="card-body dark-linear position-absolute fixed-bottom">
                                            ...
                                            <p class="p-0 m-0 text_secondary">{{ $chap }}</p>
                                            <p class="p-0 m-0 text-grey1 d-flex align-items-center"><i
                                                    class="icon-eye pt-1 pe-1"></i> Lượt xem: {{ $fl->view_count }}</p>
                                        </div>
                                    </a>
                                </li>
                            @endforeach
                                ...
                                <div class="">
                                    <a href="#" class="">
                                        <img src="img/naruto.jpg"
                                            class="w-100 max-100 m-0 p-0 mt-2 mt-lg-0 rounded img-fluid" alt="">
                                    </a>
                                </div>
                            </div>
                        @endfor
                        ...
                        @foreach ($get_story_rate_highest as $key => $_rate)
                            ...
                            <div class="ms-2 mt-2 pb-2 border-bottom d-flex d-nowrap">
                                <div class="col-1 p-0 mt-1 bg-danger rounded sq-2">
                                    <p
                                        class="text-center text-white fww-bold rounded {{ $key + 1 == 1 ? 'bg-danger' : ($key + 1 == 2 ? 'bg-success' : ($key + 1 == 3 ? 'bg-primary' : 'bg-secondary')) }}">
                                        {{ $key + 1 }}</p>
                                </div>
                                <div class="col-11">
                                    <a href="{{ getUrlStory($_rate) }}" title="{{ $_rate->title }}"
                                        class="d-block m-0 p-0 col-12 ps-2 fw-bold text-black1">{{ $_rate->title }}</a>
                                    <div class="row ms-0">
                                        ...
                                        <div class="col-3 text-end fs-12 fst-italic d-flex"><i class="icon-eye pt-1"></i>
                                            <p class="ms-1 mb-0"> {{ $_rate->view_count }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <ul class="list px-0">
                                @foreach ($category as $value)
                                    <li class="d-flex {{ strpos($value['title'], '---') === false ? '' : 'ps-4' }}">
                                        ...
                                        <span
                                            class="ms-auto">{{ $value['category_post'] == 1 ? 'Tin tức' : 'Truyện' }}</span>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
