...
@section('main')
<div>
        <section class="single-cover data-bg-image" data-bg-image="{{$oneItem->thumbnail}}" style="background-image: linear-gradient( rgb(0 0 0 / 23%), rgba(0, 0, 0, 0.7) ), url('{{$oneItem->thumbnail}}');"> <div class="container-xl"> 
            <div class="cover-content post"> 
                <nav aria-label="breadcrumb"> 
                    <ol class="breadcrumb"> 
                        ...
                        <li class="breadcrumb-item text-gray1 active" aria-current="page">{{$oneItem->meta_title}}</li>
                    </ol>
                </nav> 
